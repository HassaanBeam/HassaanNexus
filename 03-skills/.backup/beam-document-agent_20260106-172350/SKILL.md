---
name: beam-document-agent
description: Generate comprehensive, fully-detailed documentation for Beam AI agents from graph.json files. Load when user says "document beam agent", "create agent documentation", "generate agent docs", "document this agent", or provides a Beam agent graph file. Analyzes graph structure, extracts workflow, tools, integrations, descriptions, and generates complete documentation with NO placeholders.
version: 1.1
---
...
- Scenario 1: Success case
  ...
  - Expected outputs
  - Agent behavior
- Scenario 2: Edge case/alternative path
  - Alternative flow
  - Different outcomes
