...
**To run check programmatically:** Use `00-system/skills/_notion-shared/scripts/check_notion_config.py`
...
**Location:** Project root (`Nexus-v4/user-config.yaml`)
...
**Script:** `00-system/skills/_notion-shared/scripts/setup_notion.py` (to be created in Phase 3)

**What it does:**
1. Checks for existing .env and user-config.yaml
2. Guides user through API key setup
3. Tests connection
4. Retrieves user ID
5. Updates configuration files
6. Validates full setup

**Usage:**
```bash
python 00-system/skills/_notion-shared/scripts/setup_notion.py
```
...
**First time?** See [Setup Guide](../_notion-shared/references/setup-guide.md)
```
