...
description: Query Beam Nexus Skills database in Notion with filters (team, integration, name). Load when user mentions "query notion", "search skills database", "find skills in notion", or "browse notion skills".
---
